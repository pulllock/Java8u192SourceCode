...
public class ArrayBlockingQueue<E> extends AbstractQueue<E>
    ...
    public boolean remove(Object o) {
        ...
        try {
            if (count > 0) {
                final int putIndex = this.putIndex;
                // 从takeIndex处往后遍历，找到元素位置后移除，可能会移动元素
                int i = takeIndex;
                do {
                    if (o.equals(items[i])) {
                        removeAt(i);
